            ...
            For Each Prop() As String In Collprop
                ...
                ElseIf Prop(0).ToLower = "val" And ValideIf Then '* Val = ""
                    ...
                    Else 'Valeur inscrite dans le script
                        ...
                        If Prop(1) = "INSBASE" Then
                            DataList.Clear()
                            VarData.Clear()
                            Dim InsBase As Point3d = Application.GetSystemVariable("INSBASE")
                            VarData.Add(InsBase.X & "," & InsBase.Y & "," & InsBase.Z)
                        Else
        ...
        Public Function cmdCmd(ByVal Cmd As String)  ' Commande autocad à executer (exemple: "regen" )
            ...
            Else
                ...
                Using docLock As DocumentLock = doc.LockDocument
                    ...
                    ' Dim Args() As Object
                    '  Args = Split(Cmdinfo(1), "|")

                    ' Dim Csync As New CommandsAsync
                    ' Csync.CmdsAsync(Args)
...
#End If
            ...
            If Mid(HAprop(3), 1, 1) = ">" Or Mid(HAprop(3), 1, 1) = "<" Then ' New code : <  (old : >)
        ...
        Public Function cmdOBJ(ByVal Cmd As String)  ' Remarks
            ...
            Dim CollArc As New Collection
            Dim CollArcDimension As New Collection
            Dim CollBlockReference As New Collection
            Dim CollCircle As New Collection
            Dim CollDBPoint As New Collection
            Dim CollDBText As New Collection
            Dim CollDiametricDimension As New Collection
            Dim CollEllipse As New Collection
            Dim CollOthers As New Collection
            Dim CollAttribute As New Collection
            Dim CollHatch As New Collection
            Dim CollHelix As New Collection
            Dim CollLineAngularDimension2 As New Collection
            Dim CollLine As New Collection
            Dim CollMText As New Collection
            Dim CollPolyline3d As New Collection
            Dim CollPolyline2d As New Collection
            Dim CollPolyline As New Collection
            Dim CollRadialDimension As New Collection
            Dim CollRay As New Collection
            Dim CollRotatedDimension As New Collection
            ...
            Try
                ...
                Dim ObjDone As Double = 0 'Object are modified
...
#End If
                    ...
                    Catch
                        Console.WriteLine("Error1 cmdOBJ")
                    End Try
...
#End If
            ...
            Catch
                Return Connect.DateLog & "Cmd OBJ" & vbTab & False
...
#End If
            ...
            Catch ex As Exception
                Return Connect.DateLog & "Cmd STY" & vbTab & False & vbTab & "Erreur: " & ex.Message & vbTab & STYprop(2)
            End Try
